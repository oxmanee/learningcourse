...
-->
    ...
    <link rel="stylesheet" type="text/css" href="css/template/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="css/template/font-awesome.css">

    <link rel="stylesheet" href="css/template/templatemo-lava.css">
...
<body>
                ...
                <div class="right-text offset-lg-1 col-lg-6 col-md-12 col-sm-12 mobile-bottom-fix">
                    <ul>
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                            <img src="image/template/about-icon-01.png" alt="">
                            <div class="text">
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
                            <img src="image/template/about-icon-02.png" alt="">
                            <div class="text">
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.6s">
                            <img src="image/template/about-icon-03.png" alt="">
                            <div class="text">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="image/template/testimonial-author-1.png" alt="Author One"></i>
                            </div>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="image/template/testimonial-author-1.png" alt="Second Author"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="image/template/testimonial-author-1.png" alt="Author Third"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="image/template/testimonial-author-1.png" alt="Fourth Author"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
    ...
    <!-- jQuery -->
    <script src="js/template/jquery-2.1.0.min.js"></script>

    <!-- Bootstrap -->
    <script src="js/template/popper.js"></script>
    <script src="js/template/bootstrap.min.js"></script>

    <!-- Plugins -->
    <script src="js/template/owl-carousel.js"></script>
    <script src="js/template/scrollreveal.min.js"></script>
    <script src="js/template/waypoints.min.js"></script>
    <script src="js/template/jquery.counterup.min.js"></script>
    <script src="js/template/imgfix.min.js"></script>
